...
<div class="d-flex justify-content-center flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  <h1 class="h4">Tambah Produk Baru</h1>
</div>

<div class="container justify-content-center mt-5" style="width:50%" >
  <form action="/produk" class="form-container p-2" method="post">
      @csrf
      ...
      <div class="form-floating mb-3">
        <input type="text" name="harga" class="form-control rounded @error ('harga') is-invalid @enderror" id="harga" placeholder="Harga" required autofocus>
      ...
      <div class="form-floating mb-3" >
        ...
        <select name="kategori_id" class="form-select @error ('kategori_id') is-invalid @enderror" style="height: 60px" required>
